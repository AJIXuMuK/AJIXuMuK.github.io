...
{% endhighlight %}
    ...
    Now Percent column should look like this: <a href="https://1.bp.blogspot.com/-ujfsUQYG4Q4/WVwo1vaAAEI/AAAAAAAAAhM/hOz6XMocbscYqz8pfJBQClNK8QLS1hRLACLcBGAs/s1600/sliders.png" imageanchor="1"><img border="0" data-original-height="731" data-original-width="913" height="512" src="https://1.bp.blogspot.com/-ujfsUQYG4Q4/WVwo1vaAAEI/AAAAAAAAAhM/hOz6XMocbscYqz8pfJBQClNK8QLS1hRLACLcBGAs/s640/sliders.png" width="640" /></a><br />    And if a user doesn't have permissions to edit items the sliders will be disabled and grayed out:<br /><a href="https://1.bp.blogspot.com/-zVT5Jhyl4yA/WVwxC18SwlI/AAAAAAAAAhc/Hlv3otc9OEMYWtPD64lreBaGTsb7doD3gCLcBGAs/s1600/disabled-sliders.png" imageanchor="1"><img border="0" data-original-height="731" data-original-width="916" height="510" src="https://1.bp.blogspot.com/-zVT5Jhyl4yA/WVwxC18SwlI/AAAAAAAAAhc/Hlv3otc9OEMYWtPD64lreBaGTsb7doD3gCLcBGAs/s640/disabled-sliders.png" width="640" /></a><br/>    The last part of the implementation is to save values' changes to the back-end using PnP JS Core Library.<br />    Go to <span class="code">onChange</span> handler (<span class="code">onSliderValueChanged</span> method) and add the code to update the value: <br />
<div markdown="1">
{% highlight typescript %}
